  ...
  wayland.windowManager.hyprland = {
     settings = {
       ...
       bind = [
                ...
                ", Print, exec, uwsm-app -- grimblast --freeze copysave area ~/Pictures/Screenshots"
                "Ctrl, Print, exec, uwsm-app -- grimblast --freeze save area - | uwsm app -- swappy -f -"
                "SHIFT, Print, exec, uwsm-app -- grimblast copysave output ~/Pictures/Screenshots"
                "Ctrl SHIFT, Print, exec, uwsm-app -- grimblast --freeze save output - | uwsm app -- swappy -f -"
                "$mainMod, Print, exec, uwsm-app -- grimblast --freeze copysave active ~/Pictures/Screenshots"
